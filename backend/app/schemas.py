...
class ResellerPlanBase(BaseModel):
    ...
    max_traffic_bytes: Optional[int] = None
...
class ResellerPlanOut(ResellerPlanBase):
    id: int
...
class ResellerSubscriptionOut(BaseModel):
    id: int
    plan: ResellerPlanOut
    starts_at: datetime
    ends_at: datetime
    is_active: bool
...
class ResellerReport(BaseModel):
    reseller_id: int
    users: int
    services: int
    traffic_used_bytes: int
    plan: Optional[ResellerSubscriptionOut] = None
    wallet_balance: int
