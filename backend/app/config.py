...
class Settings(BaseSettings):
    ...
    backup_dir: str = Field("/var/lib/nightking/backups", env="BACKUP_DIR")
    app_version: str = Field("0.1.0", env="APP_VERSION")
    node_agent_allowed_ips: list[str] = Field(default_factory=list, env="NODE_AGENT_ALLOWED_IPS")
    rate_limit_login_per_min: int = Field(10, env="RATE_LIMIT_LOGIN_PER_MIN")
    rate_limit_sub_per_min: int = Field(120, env="RATE_LIMIT_SUB_PER_MIN")
