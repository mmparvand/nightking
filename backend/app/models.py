...
class Service(Base):
    ...
    service_nodes: Mapped[list["ServiceNode"]] = relationship("ServiceNode", back_populates="service", cascade="all, delete-orphan")
...
class Node(Base):
    ...
    service_nodes: Mapped[list["ServiceNode"]] = relationship("ServiceNode", back_populates="node", cascade="all, delete-orphan")


class ServiceNode(Base):
    __tablename__ = "service_nodes"
    __table_args__ = (UniqueConstraint("service_id", "node_id", name="uq_service_node"),)
    ...
    service: Mapped["Service"] = relationship("Service", back_populates="service_nodes")
    node: Mapped["Node"] = relationship("Node", back_populates="service_nodes")
